...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        = RefactoringIdentifiers.RemoveUnnecessaryElseClause;
        ...
        protected override void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.RemoveUnnecessaryElseClause, "Remove unnecessary else clause", IsEnabled(RefactoringIdentifiers.RemoveUnnecessaryElseClause)));
        }
